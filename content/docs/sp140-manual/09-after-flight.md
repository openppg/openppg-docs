...
toc: true
seo:
  title: "SP140 v2.5 After-Flight Care"
  description: "Essential maintenance, storage, and transport guidelines for your electric paramotor"
  canonical: ""
  noindex: false
---
...
1. Store battery in warm environment before flight
2. Allow battery to warm to 10°C+ if possible
3. Expect slightly reduced capacity initially
4. Monitor battery temperature during flight

**After Cold Weather Flight:**
1. Bring battery inside promptly
2. Allow to warm to room temperature naturally
3. Do not charge while cold
4. Check for any frost or condensation
...
4. **Check for alerts or warnings**
5. **Log battery health data**
